...
from watchlist.models import User, MovieInfo
...
class WatchlistTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with app.app_context():
            ...
            movie = MovieInfo(movie_id=str(random.randint(10 ** 2, (10 ** 5) - 1)),
                              movie_name="测试的电影名",
                              release_date=datetime(int(release_date[0:4]), int(release_date[5: 7]),
                                                    int(release_date[8:])),
                              country="中国",
                              movie_type="戏剧",
                              year="2008"
    ...
    def test_index_page(self):
        ...
        data = response.get_data(as_text=True)
        self.assertIn('根据类型查找', data)
        self.assertIn('演员名', data)
    ...
    def test_forge_command(self):
        with app.app_context():
            ...
            self.assertNotEqual(MovieInfo.query.count(), 0)
